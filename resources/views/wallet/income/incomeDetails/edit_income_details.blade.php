        ...
        <div class="container-full">
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col">
                            <form method="POST" action="{{ route('income.update', $income_details->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                                ...
                                                <select name="category" required="" class="form-control">
                                                    ...
                                                    @foreach ($category as $data)
                                                        <option value="{{ $data->id }}"
                                                            {{ $income_details->category == $data->id ? 'selected' : '' }}>
                                                            {{ $data->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="controls">
                                                <select name="mode" id="mode" required="" class="form-control">
                                                    ...
                                                    <option value="Digital"
                                                        {{ $income_details->mode == 'Digital' ? 'selected' : '' }}>Digital
                                                    </option>
                                                    <option value="Cash"
                                                        {{ $income_details->mode == 'Cash' ? 'selected' : '' }}>Cash
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <select name="account_id" required="" class="form-control"
                                                    ...
                                                    @foreach ($account_details as $account)
                                                        <option value="{{ $account->id }}"
                                                            {{ $income_details->account_id == $account->id ? 'selected' : '' }}>
