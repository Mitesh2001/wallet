            ...
            <section class="content">
                <div class="col-12">
                    <div class="box bb-3 border-warning">
                        ...
                        <div class="box-body">
                            <form method="POST" action="{{ route('income.report') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2 d-flex justify-content-between" style="padding-top: 25px;">
                                        ...
                                        <input type="submit" class="btn btn-rounded btn-dark mb-5" value="PDF" name="pdf"></input>
                                        <input type="submit" class="btn btn-rounded btn-dark mb-5" value="Mail" name="mail"></input>
                                    </div>
                                </div>
                            </form>
                        </div>
